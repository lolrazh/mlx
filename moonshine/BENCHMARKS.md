...
| **Parakeet TDT 0.6b v2 8-bit** | 8-bit g64 (Linear/Embedding) | 1.91% | 0.024 | 1.26 GB | parakeet-mlx, Python 3.11, English-only; fastest model tested |
| Parakeet TDT 0.6b v2 bf16 | none | 1.87% | 0.030 | 2.10 GB | quantization costs +0.04pp for -40% RAM |
...
3. **8-bit is nearly free.** Parakeet v2: +0.04pp WER for -40% RAM, -20% inference time. Sub-4-bit or aggressive mixed quant was never worth it (Whisper sweep).
